            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{ asset('images/EncryptionApp.png') }}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{ asset('images/encryption interface.png') }}" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project date</strong>: 18 October. 2023</li>
                <li><strong>cryptoproject.vercel.app</strong>: <a href="#">cryptoproject.vercel.app</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>This is an example of an encryption algorithms app.</h2>
              <p>
                Introducing my Encryption Algorithm App: Xavie's encryption app</p>

              </p>Xavie's encryption app is a cutting-edge web application designed to provide robust encryption capabilities using various encryption algirthms for your sensitive data.
                 With Xavie's encryption app, you can ensure the confidentiality and integrity of your information, 
                protecting it from unauthorized access and interception. </p>
            </div>
          </div>
