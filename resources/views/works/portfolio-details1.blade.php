            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{ asset('images/onlinestoreimg.png') }}" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project date</strong>: 25 Novembre, 2023</li>
                <li><strong>Project URL</strong>: <a href="https://myonlinestoreproject-ddf84310f22e.herokuapp.com">https://myonlinestoreproject-ddf84310f22e.herokuapp.com</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>This is an example of an OnlineStore App</h2>
              <p>
                Welcome to our online store web app, the ultimate destination for a seamless and personalized shopping experience. With a sleek and intuitive interface, our web app allows you to effortlessly browse, search, and discover a wide range of products from the comfort of your own device. Enjoy a secure and streamlined checkout process, multiple payment options, and reliable shipping services, ensuring that your shopping journey is smooth from start to finish. Whether you're shopping for fashion, electronics, home goods, or more, our web app is your go-to destination for all your online shopping needs. Experience the convenience and satisfaction of online shopping in one powerful and user-friendly platform.</p>
            </div>
          </div>
