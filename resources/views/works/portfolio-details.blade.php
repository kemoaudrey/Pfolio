          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project URL</strong>: <a href="https://tiktaktoeproject-2059d07ac433.herokuapp.com">https://tiktaktoeproject-2059d07ac433.herokuapp.com</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>This is an example of a TicTacToe app</h2>
              <p>
                Tic Tac Toe is a classic game that challenges players to strategically place their X or O markers on a 3x3 grid with the goal of forming a winning pattern. With simple rules and endless possibilities, Tic Tac Toe is a game of skill, logic, and prediction. Players take turns, carefully planning their moves to block their opponent's progress while simultaneously setting up their own winning opportunities. Whether played casually for fun or competitively to showcase strategic prowess, Tic Tac Toe offers a timeless and enjoyable experience for players of all ages. </p>
            </div>
          </div>
